...
| 38 | [T1190 – Exploit Public-Facing Application](https://attack.mitre.org/techniques/T1190/) (+ [T1595.002 – Active Scanning](https://attack.mitre.org/techniques/T1595/002/)) | Suricata 9100020–9100024 + Wazuh 100440, 100441, 100442 | rtr-01 (inline Suricata) → siem-01 | 🔧 **built as detection-as-code, live-fire pending** (lab off 2026-09-06) — **DMZ web-attack detection** for OWASP Juice Shop: SQLi (URI + POST body), XSS, path-traversal, and scanner-UA sigs, escalated to labeled T1190 SIEM alerts (100440) with a burst-correlation rule (100442). Closes the lab's last gap — the DMZ had attack surface + log ingestion but **no detection**. Finding: ET Open web rules key on `$HTTP_PORTS` and were blind to Juice Shop's port 3000 (fixed in the `router` role). Exercise: [`phase-5-offense/web-attacks/`](../phase-5-offense/web-attacks/); writeup [`03-web-attack-juiceshop-t1190.md`](../phase-5-offense/attack-detect-writeups/03-web-attack-juiceshop-t1190.md) (2026-09-06) |
