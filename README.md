...
[![ATT&CK techniques](https://img.shields.io/badge/ATT%26CK-41_techniques-c9302c)](phase-4-detection/detection-catalog.md)
...
| 4 | Detection engineering | ✅ Complete (26 techniques across 7 tactics — 12 core + 9 Discovery + 3 LOLBin + UAC-bypass + SMB lateral movement, `phase-4-detection/detection-catalog.md`) |
